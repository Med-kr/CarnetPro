...
class Category extends Model
{
    ...
    {
        return [
            'tag' => ['emoji' => ':tag:', 'label' => 'General'],
            'groceries' => ['emoji' => ':cart:', 'label' => 'Groceries'],
            'rent' => ['emoji' => ':home:', 'label' => 'Rent'],
            'utilities' => ['emoji' => ':bulb:', 'label' => 'Utilities'],
            'internet' => ['emoji' => ':wifi:', 'label' => 'Internet'],
            'transport' => ['emoji' => ':bus:', 'label' => 'Transport'],
            'food' => ['emoji' => ':plate:', 'label' => 'Food'],
            'cleaning' => ['emoji' => ':soap:', 'label' => 'Cleaning'],
            'health' => ['emoji' => ':pill:', 'label' => 'Health'],
            'fun' => ['emoji' => ':sparkles:', 'label' => 'Fun'],
        ];
    }
