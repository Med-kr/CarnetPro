...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        if (! Auth::attempt($this->only('email', 'password'), $this->boolean('remember'))) {
            ...
            $message = $this->filled('invitation')
                ? __('This email is treated as an existing account. If you never created a password, use the Register link from this invitation.')
